...
<table style="width: 100%; border-collapse: collapse; border: none;">
  <tr>
    <td width="50%" valign="top" style="padding-right: 12px; border: none; color: #57606a;">
      <p align="justify" style="margin-top: 0; color: #57606a;">
...
<table>
<tr>
<td width="50%" valign="top" style="color: #57606a;">
...
<br />
<small style="color: #57606a;"><strong>Figura 1.</strong> Selección y características del conjunto de datos SDNET2018.</small>
</p>
...
<br />
<small style="color: #57606a;"><strong>Figura 2.</strong> Proporciones de división del conjunto de datos.</small>
</p>

<p align="center">
<img src="Figura 3_Figura_3_CNN.png" alt="Figura 3" width="100%" />
<br />
<small style="color: #57606a;"><strong>Figura 3.</strong> Flujo detallado de la partición estratificada.</small>
</p>
...
<br />
<small style="color: #57606a;"><strong>Figura 4.</strong> Arquitectura de la Red Neuronal Convolucional (CNN).</small>
</p>
